...
public class RightPageTestIE {
    ...
    public void rightRage(){
        ...
        String[] itemOldPriceColor = itemOldPriceRGB.replaceAll("[rgba(\\)]", "").split(",");
        ...
        String[] itemNewPriceColor = itemNewPriceRGB.replaceAll("[rgba(\\)]", "").split(",");
        ...
        String[] itemOldPriceOpenedColor = itemOldPriceOpenedRGB.replaceAll("[rgba(\\)]", "").split(",");
        ...
        String[] itemNewPriceOpenedColor = itemNewPriceOpenedRGB.replaceAll("[rgba(\\)]", "").split(",");
